...
More details about the analysed data set in link: <http://hdr.undp.org/sites/default/files/hdr2015_technical_notes.pdf>
...
##I had knit problem, so I managed the problem by saving the variable tea into a test file
...
```
The results shows how people drink treir tea. For example people who takes green tea, they also  buy tea from chain store. Unpacked teas are buyed from tea shop. People who drink black tea they don't use sugar and don't drink it at lunch. People who use tea bag also uses sugar more often.
